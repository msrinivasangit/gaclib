...
{
$id=$_GET['del'];
$sql = "delete from tb_books WHERE book_id=:id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>                               
<?php $sql = "SELECT book_id, title, author1, acc_number, publication, place_of_publication, cost, year_of_publication, isbn from tb_books";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo ucwords(htmlentities(($result->acc_number)));?></td>
                                            ...
                                            <td class="center"><?php echo ucwords(htmlentities(($result->year_of_publication)));?></td>
                                            <td class="center"><?php echo ucwords(htmlentities(($result->cost)));?></td>
                                            <td class="center">
