                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tb_members.name,tb_books.title,tb_books.isbn,td_bookissue.issue_date,td_bookissue.return_date,td_bookissue.id as rid from  td_bookissue join tb_members on tb_members.member_id=td_bookissue.member_id  join tb_books on tb_books.book_id=td_bookissue.book_id order by td_bookissue.id desc";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php if($result->return_date=="0000-00-00 00:00:00")
                                            {
