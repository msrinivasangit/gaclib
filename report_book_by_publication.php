...
if(isset($_POST['search']))
{
    if(empty($_POST['publication'])){
        $msg = 'Please Fill the publication';
    }else{
        $wheres[]= "publication like '%".$_POST['publication']."%'";
    }
}
...
<head>
    ...
    <title>Online Library Management System | Report By Publication</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Report By publication</h4>
    </div>
    ...
    <div class="col-md-3">
        <form role="form" method="post">
            ...
            <label>&nbsp;</label>
            <button class="form-control btn btn-info"  onclick="javascript:xport.toCSV('dataTables-example','publication-report');">Export to XLS</button>&nbsp;
        </form>
    </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>                               
<?php $sql = "SELECT book_id, title, publication, acc_number, publication, place_of_publication, cost, year_of_publication, isbn, book_available_status from tb_books ".$where;
