...
$sql ="SELECT member_id,name,email,password,employee_id,status,is_super_admin,is_staff FROM tb_members WHERE is_staff=1 and status=1 and employee_id=:employee_id and password=:password";
...
<div class="col-md-12">
<h4 class="header-line">STAFF LOGIN FORM</h4>
</div>
</div>
